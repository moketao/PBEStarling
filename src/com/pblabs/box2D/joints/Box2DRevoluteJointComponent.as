	...
	public class Box2DRevoluteJointComponent extends EntityComponent {
		...
		public function set worldAnchor(value:Point):void {
			...
			if (_spatial1.body == null || _spatial2.body == null) {
				...
				trace("worldAnchor can only be adjusted if both spatials are already active in the world.");
				return;
			}
		...
		private function updateAnchors():void {
			var worldPoint:b2Vec2 = new b2Vec2(_worldAnchor.x, _worldAnchor.y);
			var point1:b2Vec2 = spatial1.body.GetLocalPoint(worldPoint);
			var point2:b2Vec2 = spatial2.body.GetLocalPoint(worldPoint);
